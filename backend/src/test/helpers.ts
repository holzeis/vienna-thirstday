...
export async function resetDb() {
  await db.execute(
    sql`TRUNCATE users, players, gamedays, registrations, team_assignments, results, player_gameday_stats, player_merges, invites, push_subscriptions, access_events, password_reset_tokens RESTART IDENTITY CASCADE`
  );
}
